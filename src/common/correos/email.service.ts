...
export class EmailService {
  async sendMailNotifyPaymentAndAttachmentsMailtrap(to: string, subject: string, paymentData: any, reciboPath: string, facturaPathPdf: string, facturaPathXml: string) {
    ...
    try {
      const templateEmail = path.join(process.cwd(), 'plantillas', `correo_notificacion_pago.html`);
